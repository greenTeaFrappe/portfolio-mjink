...
import com.mjink.portfolio.domain.entity.ProjectDetail
...
class ProjectRepositoryTest(
    ...
    private fun createProject(n: Int): Project {
        ...
        val skillsUsedInProject = skills.subList(0, n) // 총 n개의 데이터 잘라옴
    ...
    fun beforeAll() {
        ...
        for (i in 1..DATA_SIZE) {
            val skillTypes = SkillType.values()                   // 데이터가 4개 있으면 0 1 2 3 반복해줌 스킬 타입을 하나만 집어서 가져올 수 있음
